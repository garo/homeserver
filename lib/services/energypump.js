...
exports.init = function (cb) {
  ...
  function next() {
    exports.setAtHomeState(previousState.athome, function() {
      ...
      setInterval(exports.checkInputs, 1000);
...
exports.checkInputs = function() {
  var inputs = homeserver.drivers.piface.readInputs();
  console.log("Inputs", inputs.toString(2));
};
...
exports.getAtHomeState = function(cb) {
  exports.getState(function (err, state) {
    cb(null, state.athome);
  });
};
